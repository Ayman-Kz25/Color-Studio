...
export const DEFAULT_BASE_COLOR = "#E5487A";
...
export const DEFAULT_COLOR_FORMAT =
  COLOR_FORMATS.HEX;
...
export const STORAGE_KEYS = Object.freeze({
  SAVED_PALETTES:
    "colorStudio_savedPalettes",

  SETTINGS:
    "colorStudio_settings",
});
...
export const MESSAGES = Object.freeze({
  ...
  STORAGE_ERROR:
    "Unable to access saved palettes",

  COPY_ERROR:
    "Unable to copy color",

  PALETTE_GENERATION_ERROR:
